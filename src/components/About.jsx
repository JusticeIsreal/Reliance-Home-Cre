...
const About = () => {
  return (
    <div className="  flex flex-col lg:flex-row justify-between items-center lg:px-15 xl:px-20 px-5 pt-10 lg:mt-20 gap-5">
      <div className=" w-full lg:w-3/4 space-y-4">
        ...
        <p className="lg:text-start">
          ...
          We do not discriminate anyone on the basis of gender, color, race,
          origin, ethnicity, nationality or creed. Whoever you are and as long
          as you are qualified and in need of our services, our doors are always
          open for you. We are located in 2625 Butterfield Road, Suite 314E,
          Oakbrook, Illinois 60523. You can click here to take a look at our
          map.
        </p>
