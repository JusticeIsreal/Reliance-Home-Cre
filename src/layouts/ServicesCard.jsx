...
const ServicesCard = ({ icon, title }) => {
  return (
    <div className=" group flex flex-col items-center text-center gap-2 w-full  md:w-[47%]  lg:w-[30%] xl:w-[32%] p-5 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg cursor-pointer lg:hover:shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] transition duration-300 ease-in-out">
